/**
 * This class represents open enrolled liberal arts students from Iowa
 * @author Sophia Mallaro
 * @see IowaLiberalArtsOpen
 */
public class IowaLiberalArtsOpen extends LiberalArtsOpen {
    /**
     ...
     */
    IowaLiberalArtsOpen(String firstName, String lastName, String studentID,
    ...
    public double getTuition() {
        if(getNumberOfRegisteredHours() < LiberalArtsOpen.getFullLoad() ){
            ...
            return(super.getTuition() - ((LiberalArtsOpen.getFullLoad()*0.35*Student.getBaseTuition()) + ((getNumberOfRegisteredHours()-LiberalArtsOpen.getFullLoad())*0.1*Student.getBaseTuition())));
        }
    }
    /**

/**
 * C@author Sophia Mallaro
 * @see OtherEngineeringUndergrad
 */
public class OtherEngineeringUndergrad extends EngineeringUndergrad {
    /**
     ...
     */
    OtherEngineeringUndergrad(String firstName, String lastName, String studentID,
